...
DEPLOY_ENV=prod
DEPLOY_HOST=livemap.glicksoftware.com
DEPLOY_PORT=22
DEPLOY_USER=plone
DEPLOY_FOLDER=/srv/livemap/data
...
You need either a Ubuntu or Debian based system for livemap.glicksoftware.com, enable SSH, and install a supported version of Python 3 on that system.
...
prod:
  hosts:
    livemap.glicksoftware.com:
      ansible_user: root
      host: livemap
      hostname: livemap.glicksoftware.com
```
...
Deploy the stack defined in `devops/stacks/livemap.glicksoftware.com.yml` to the remote server with:
